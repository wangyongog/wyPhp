...
class main extends Controller{
    ...
    public function actionIndex(){
       // print_r($this->get('s'));
        ...
        //makeCookie('kkkkkk','gggggg');
        echo getCookie('kkkkkk');
    ...
    public function actionSession(){
        $Session = new WyPhp\Session();
        $_SESSION['aaa6666'] = '1111';
        //$_SESSION['aaa'] = ['ttt'=>1111];
        //print_r($_SESSION['aaa']);exit;
        //$_SESSION['aaa'] = 'ggg';
        //echo $_SESSION['aaa'];exit;
        echo  $_SESSION['aaa6666'];
    }
