...
class Verify {
    protected $config =	array(
        'seKey'     =>  'd$dkls*idk23123idk*09',   // 验证码加密密钥
        'codeSet'   =>  '12345678abcdefhijkmnpqrstuvwxyzABCDEFGHJKLMNPQRTUVWXY',             // 验证码字符集合
    ...
    public function check($code, $id = '') {
        ...
        // session 过期
        if(TIMESTAMP - $secode['verify_time'] > $this->expire) {
            session($key, null);
            return false;
        }
    ...
    public function entry($id = '') {
        ...
        $secode['verify_time'] = TIMESTAMP;  // 验证码创建时间*/
