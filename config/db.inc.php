...
return [
    ...
    'fi_' =>[
        'master' =>'host:127.0.0.1,port:3306,user:root,database:chinawy_finance,password:root,charset:utf8mb4,dbtype:mysql,prefix:fi_',
        //'slave' =>'host:192.168.2.166,port:3306,user:leku008,database:aiyihema,password:123456,charset:utf8mb4,dbtype:mysql,prefix:dede_'
    ],
    'log_' =>[
        'master' =>'host:127.0.0.1,port:3306,user:root,database:chinawy_logs,password:root,charset:utf8mb4,dbtype:mysql,prefix:log_',
        //'slave' =>'host:192.168.2.166,port:3306,user:leku008,database:aiyihema,password:123456,charset:utf8mb4,dbtype:mysql,prefix:dede_'
    ],
    'mongo_' =>[
